      ...
      <div className="container py-[1vw] text-white relative z-10 ml-[8vw]">
        <AnimatePresence>
          ...
          <motion.button
            ...
            className="bg-gray-700 text-white font-semibold sm:px-[1.5vw] py-[0.5vw]   ml-[50vw] sm:ml-[1vw] text-[#3e3e3e] mt-[2vw] p-[4vw] flex items-center justify-center rounded-[28vw] rounded hover:bg-gray-800 shadow-lg"
            style={{
              fontFamily: 'Bellota Text',
              // fontSize: '1.4vw',
              // backgroundColor: '#3E3E3E',
