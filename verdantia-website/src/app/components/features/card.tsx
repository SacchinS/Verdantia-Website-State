  ...
  export const Tech = ({id} : CardProps) => {
    return(
        <FeatureCard id={id} gradient="from-[#f7f0ff] to-[#a78afe]">
            <img className="rounded-xl shadow-lg absolute left-[18%] top-[7%] w-[65%]" src={tech.src}/>
            <p className="px-[5vw] absolute top-[56%] text-[1vw] text-[#3e3e3e]">
            ...
            <p className="px-[5vw] absolute top-[82%] text-[1vw] text-[#3e3e3e]">
  ...
  export const Path = ({id} : CardProps) => {
    return(
        <FeatureCard id={id} gradient="from-[#f5fbff] to-[#addeff]">
            <img className="rounded-xl shadow-lg absolute left-[18%] top-[7%] w-[63%]" src={path.src}/>
            <p className="px-[5vw] absolute top-[56%] text-[1vw] text-[#3e3e3e]">
            ...
            <p className="px-[5vw] absolute top-[73%] text-[1vw] text-[#3e3e3e]">
  ...
  export const Community = ({id} : CardProps) => {
    ...
    return(
        <FeatureCard id={id} gradient="from-[#f5fff7] to-[#adf8ff]">
            <img className="rounded-xl shadow-lg absolute left-[20.4%] top-[7%] w-[57%]" src={community.src}/>
            <p className="px-[5vw] absolute top-[56%] text-[1vw] text-[#3e3e3e]">
  ...
  export const Hours = ({id} : CardProps) => {
    return(
        <FeatureCard id={id} gradient="from-[#f7fff5] to-[#adffd8]">
            <img className="rounded-xl shadow-lg absolute left-[24.8%] top-[7%] w-[47%]" src={hours.src}/>
            <p className="px-[5vw] absolute top-[56%] text-[1vw] text-[#3e3e3e]">
            ...
            <p className="px-[5vw] absolute top-[80%] text-[1vw] text-[#3e3e3e]">
  ...
  export const Health = ({id} : CardProps) => {
    return(
        <FeatureCard id={id} gradient="from-[#fff7f5] to-[#ffd8ad]">
            <img className="rounded-xl shadow-lg absolute left-[25.8%] top-[7%] w-[47%]" src={health.src}/>
            <p className="px-[5vw] absolute top-[56%] text-[1vw] text-[#3e3e3e]">
